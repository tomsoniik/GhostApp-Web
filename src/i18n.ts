export const translations: Record<string, Record<string, string>> = {
  pl: {
    ...
    'auth.label.username': 'Nazwa Użytkownika',
    'auth.label.code': 'Kod Weryfikacyjny z E-Maila',
    'auth.pass.lower': 'mała litera (a-z)',
    'auth.pass.upper': 'duża litera (A-Z)',
    'auth.pass.digit': 'cyfra (0-9)',
    'auth.pass.special': 'znak specjalny (!@#$)',
    'auth.pass.weak': 'Hasło nie spełnia wymagań.',
    'auth.user.short': 'Min. 3 znaki.',
    ...
    'dash.stats.disconnected': 'Rozłączony',
    'dash.stats.rules': 'Aktywne Reguły',
    'dash.stats.total': 'Łącznie',
  ...
  en: {
    ...
    'auth.pass.lower': 'lowercase (a-z)',
    'auth.pass.upper': 'uppercase (A-Z)',
    'auth.pass.digit': 'digit (0-9)',
    'auth.pass.special': 'special char (!@#$)',
    'auth.pass.weak': 'Password does not meet requirements.',
    'auth.user.short': 'Min. 3 characters.',
    ...
    'dash.stats.disconnected': 'Disconnected',
    'dash.stats.rules': 'Active Rules',
  ...
  ru: {
    ...
    'auth.pass.lower': 'строчная (a-z)',
    'auth.pass.upper': 'заглавная (A-Z)',
    'auth.pass.digit': 'цифра (0-9)',
    'auth.pass.special': 'спецсимвол (!@#$)',
    'auth.pass.weak': 'Пароль не соответствует требованиям.',
    'auth.user.short': 'Мин. 3 символа.',
    ...
    'dash.stats.disconnected': 'Отключен',
    'dash.stats.rules': 'Активные правила',
    'dash.stats.total': 'Всего',
